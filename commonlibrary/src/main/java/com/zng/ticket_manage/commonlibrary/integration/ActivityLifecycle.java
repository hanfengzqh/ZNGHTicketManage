...
import com.zng.ticket_manage.commonlibrary.base.BaseFragment;
import com.zng.ticket_manage.commonlibrary.base.delegate.ActivityDelegate;
import com.zng.ticket_manage.commonlibrary.base.delegate.ActivityDelegateImpl;
import com.zng.ticket_manage.commonlibrary.base.delegate.FragmentDelegate;
...
import com.zng.ticket_manage.commonlibrary.utils.Preconditions;
 ...
 * 通过 { ActivityDelegate} 管理 {@link Activity}
 * 对Activity的生命周期进行统一管理
 */
@Singleton
