...
public interface Cache<K, V> {
    ...
    /**
     * 返回这个 {@code key} 在缓存中对应的 {@code value},
     * 如果返回 {@code null} 说明这个 {@code key} 没有对应的 {@code value}
     *
     * @param key
     * @return
     */
    ...
    /**
     * 将 {@code key} 和 {@code value} 以条目的形式加入缓存,
     * 如果这个 {@code key} 在缓存中已经有对应的 {@code value}
     * 则此 {@code value} 被新的 {@code value} 替换并返回,
     * 如果为 {@code null} 说明是一个新条目
     *
     * @param key
     * @param value
     * @return
