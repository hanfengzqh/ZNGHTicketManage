...
import com.zng.ticket_manage.commonlibrary.utils.CharacterHandler;
import com.zng.ticket_manage.commonlibrary.utils.ZipHelper;
...
public class RequestInterceptor implements Interceptor {
    ...
    @Inject
    public RequestInterceptor(@Nullable GlobalHttpHandler mHandler, @Nullable Level printLevel) {
    ...
    /**
     * 字符串格式化方法
     * [GET] 「 https://api.github.com/users?since=1&per_page=10 」>>> Request_Info(6924)
     *
     * @param request
     * @param tag
     * @return
