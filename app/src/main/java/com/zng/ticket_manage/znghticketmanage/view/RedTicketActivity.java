...
public class RedTicketActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void submit() {
        ...
        String taxCode = "12345678901234557891";
        ...
        params.put(Contacts.Key.MT, Contacts.Const.REDTICKET + "");
